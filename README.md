...
Move into the project **`thirdparty`** directory. If there is not any thirdparty folder, then create it.

`mkdir thirdparty && cd thirdparty`

Then for CMake execution:
```
...
### Compiling
To compile the project, first, create a `build` directory in the main directory of the project and change to that directory:
```
